...
const Banner = () => {
    return (
        <Box display='flex' mb='2rem' minHeight='80vh' sx={{ justifyContent: { xs: 'center', sm: 'center' } }} >
            <Box alignItems='center' display='flex' sx={{ flexDirection: { xs: 'column', sm: 'row' }, textAlign: { xs: 'center', sm: 'left' }, justifyContent: { xs: 'space-evenly', sm: 'space-evenly' }, minWidth: { sm: '60vw' } }} >
                <Box mx='2rem' >
                    ...
                    <Typography letterSpacing='2px' my='0.5rem' mx='0' fontFamily='Syne' fontWeight='700' fontSize='24px' variant='h2' >A Front<span className='span-green' >-</span>end Developer<span className='span-green' >.</span> </Typography>
