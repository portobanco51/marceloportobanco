...
const ProjectCard = ({ data }) => {
    ...
    return (
        <Box maxWidth='200px' border='1px solid #d8fd3890' borderRadius='30px' display='flex' position='relative' bgcolor='#303030' alignItems='center' boxShadow='0px 10px 20px 0px #00000060' mt='0.5rem' minWidth='8vw' maxHeight='1rem' minHeight='18rem' className='project-card' style={{ backgroundImage: `url(${img})`, backgroundBlendMode: 'multiply', backgroundSize: 'cover', backgroundPosition: 'center', flexFlow: 'column nowrap' }} >
            <Link borderRadius='30px' justifyContent='space-between' color='#fff' target='_blank' rel='noopener noreferrer' href={url} underline='none' >
