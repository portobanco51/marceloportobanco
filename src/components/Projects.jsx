    ...
    return (
        <Box>
            <Box display='flex' flexDirection='column' gap='2rem' justifyContent='space-evenly' maxWidth='100vw' minHeight='75vh'>
                <Typography fontSize='30px' className='projects-shadow' textAlign='center' fontFamily='Syne' fontWeight='700' letterSpacing='6px' my='3rem' mx='auto' color='#D8FD38'>PROJECTS</Typography>
